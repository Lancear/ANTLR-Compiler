...
import specs.class_content.Field;
import specs.class_content.Method;

import java.util.Collection;
import java.util.HashMap;

public class JvmClass extends specs.JvmClass {
  ...
  public JvmClass(String className, String superName, int accessFlags) {
    super(
      ...
      className,
      superName,
      new impl.data_areas.ConstantPool(),
      new HashSet<>(),
      new HashMap<>(),
      new HashMap<>(),
      new HashMap<>()
  ...
  public Field addField(String name, String descriptor, int accessFlags) {
    Field field = new impl.class_content.Field(this, name, descriptor, accessFlags);
  ...
  public Method addMethod(String name, String descriptor, int accessFlags) {
    Method method = new impl.class_content.Method(this, name, descriptor, accessFlags);
