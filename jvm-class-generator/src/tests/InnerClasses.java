...
public class InnerClasses extends Test {
  ...
  public void generate() {
    JvmClass Node = new impl.JvmClass(nodeName, Descriptor.NAME_OF(Object.class), AccessFlags.PROTECTED | AccessFlags.SUPER);
    ...
    JvmClass Main = new impl.JvmClass(name, Descriptor.NAME_OF(Object.class), AccessFlags.PUBLIC | AccessFlags.SUPER);
    ( (specs.attributes.InnerClasses)Main.addAttribute("InnerClasses") ).add(Node, nodeName);
